    ...
    return l.widget("ui.tabs", {
        ...
        _processTabs: function() {
            ...
            this.anchors.each(function(t, e) {
                ...
                a = o.element.find(o._sanitizeSelector(i))) : (i = "#" + (s = r.attr("aria-controls") || l({}).uniqueId()[0].id),
                (a = o.element.find(i)).length || (a = o._createPanel(s)).insertAfter(o.panels[t - 1] || o.tablist),
        ...
        _eventHandler: function(t) {
            ...
            t.preventDefault(),
            a.hasClass("ui-state-disabled") || a.hasClass("ui-tabs-loading") || this.running || s && !e.collapsible || !1 === this._trigger("beforeActivate", t, o) || (e.active = !n && this.tabs.index(a),
            this.active = s ? l() : a,
        ...
        load: function(t, a) {
            ...
            this._isLocal(e[0]) || (this.xhr = l.ajax(this._ajaxSettings(e, a, h)),
...
!function(e) {
    ...
    return d.widget("ui.accordion", {
        ...
        _createIcons: function() {
            ...
            e && (d("<span>").addClass("ui-accordion-header-icon ui-icon " + e.header).prependTo(this.headers),
        ...
        _animate: function(e, i, t) {
            ...
            var s, n, r, o = this, h = 0, d = e.css("box-sizing"), c = e.length && (!i.length || e.index() < i.index()), l = this.options.animate || {}, u = c && l.down || l;
            ...
            void e.hide().animate(this.showProps, {
                ...
                step: function(e, t) {
                    t.now = Math.round(e),
                    "height" !== t.prop ? "content-box" === d && (h += t.now) : "content" !== o.options.heightStyle && (t.now = Math.round(s - i.outerHeight() - h),
                    h = 0)
                }
